...
ScreenLvl_10::ScreenLvl_10(bool startEnabled) : Module(startEnabled)
{
	// curtain animation
...
ScreenLvl_10::~ScreenLvl_10()
{

}

// Load assets
bool ScreenLvl_10::Start()
{
	App->tetronimo->Enable();

	LOG("Loading lvl 10 background assets");
...
update_status ScreenLvl_10::Update()
{
...
update_status ScreenLvl_10::PostUpdate()
{
	...
	App->render->TextDraw("10", 353, 418, 0, 0, 150, 255, 16);
...
void ScreenLvl_10::lvl_lose(const char* ch_loseContinue)
{
