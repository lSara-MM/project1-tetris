...
update_status ScreenDiffSelect::Update()
{
	...
	if ((delta_Time >= 7100) && (delta_Time <= 7200))
	{
		if (colour == 1)
		{
	...
	if ((delta_Time >= 7200) && (delta_Time <= 7300))
	{
	...
	if ((delta_Time >= 7400) && (delta_Time <= 7500))
	{
		if (colour == 1)
		{
	...
	if ((delta_Time >= 7500) && (delta_Time <= 7600))
	{
		if (colour == 1)
		{
	...
	if ((delta_Time >= 7600) && (delta_Time <= 7700))
	{
		if (colour == 1)
		{
	...
	if ((delta_Time >= 7700) && (delta_Time <= 7800))
	{
		delta_Time = 7000;
