...
ScreenLvl_5::ScreenLvl_5(bool startEnabled) : Module(startEnabled)
{
	// curtain animation
...
ScreenLvl_5::~ScreenLvl_5()
{

}

// Load assets
bool ScreenLvl_5::Start()
{
	App->tetronimo->Enable();

	LOG("Loading lvl 5 background assets");
...
update_status ScreenLvl_5::Update()
{
...
update_status ScreenLvl_5::PostUpdate()
{
	...
	App->render->TextDraw("5", 353, 418, 0, 0, 150, 255, 16);
...
void ScreenLvl_5::lvl_win()
{
	...
	if (v_WinLose == 604)		// cambiar (depende del bonus)
	{
		...
		App->fade->FadeToBlack(this, (Module*)App->sLvl_6, 0);
	}
...
void ScreenLvl_5::lvl_lose(const char* ch_loseContinue)
{
