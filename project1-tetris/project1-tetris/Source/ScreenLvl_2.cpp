...
ScreenLvl_2::ScreenLvl_2(bool startEnabled) : Module(startEnabled)
{
	// curtain animation
...
ScreenLvl_2::~ScreenLvl_2()
{

}

// Load assets
bool ScreenLvl_2::Start()
{
	App->tetronimo->Enable();

	LOG("Loading lvl 2 background assets");
...
update_status ScreenLvl_2::Update()
{
...
update_status ScreenLvl_2::PostUpdate()
{
	...
	App->render->TextDraw("2", 353, 418, 0, 0, 150, 255, 16);
...
void ScreenLvl_2::lvl_win()
{
	...
	if (v_WinLose == 604)		// cambiar (depende del bonus)
	{
		...
		App->fade->FadeToBlack(this, (Module*)App->sLvl_3, 0);
	}
...
void ScreenLvl_2::lvl_lose(const char* ch_loseContinue)
{
